        ...
        <div class="container">
            <nav class="nav-default">
                ...
                <div class="nav-mobile-links">
                    <ul class="nav-links">
                        <li>
                            <a class="header-link {{ request()->routeIs('home') ? 'active' : '' }}"
                                href="{{ route('home') }}" title="Início" aria-label="Início">Início</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="header-link {{ request()->routeIs('about') ? 'active' : '' }}"
                                href="{{ route('about') }}" title="Sobre nós" aria-label="Sobre nós">Sobre nós</a>
                        </li>

                        <li>
                            <a class="header-link {{ request()->routeIs('contact') ? 'active' : '' }}"
                                href="{{ route('contact') }}" title="Contato" aria-label="Contato">Contato</a>
                        </li>
                        <li>

                            <a class="btn-geral" href="{{ $site_configurations->donation_link }}" target="_blank"
                                title="Fazer doação" aria-label="Fazer doação">Fazer
                                doação</a>
                        </li>
                    </ul>
                    ...
                    <ul class="iconify-links">
                        <li>
                            <a href="{{ $site_configurations->facebook }}" target="_blank" class="iconify-link"
                        ...
                        <li>
                            <a href="{{ $site_configurations->instagram }}" target="_blank" class="iconify-link"
                        ...
                        <li>
                            <a href="https://wa.me/+55{{ $GLOBALS['whatsapp_link'] }}" target="_blank"
                                class="iconify-link" title="Ir para o Whatsapp da Casa Amarela"
