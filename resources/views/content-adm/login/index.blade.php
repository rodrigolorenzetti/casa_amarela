		...
		<form id="form-login">
			...
			<div class="form-fields">
				<div class="input-group">
					...
					<input type="email" name="email" id="email" placeholder="Digite seu e-mail" class="input-control required">
				...
				<div class="input-group">
					...
					<input type="password" name="password" id="password" placeholder="Digite sua senha" class="input-control required">
			...
			<p class="error-text geral-text">
				...
				E-mail ou senha incorreta. Tente novamente</p>
