...
<head>
    ...
    <link rel="stylesheet" href="/lib/simditor-2.3.28/styles/simditor.css" />
    ...
    <link rel="stylesheet" href="{{ mix('css/admin/style_admin.css') }}">
...
<body id="page-top">
                            ...
                            <div class='dropdown-menu' aria-labelledby='dropdownAdminMenu'>
                                <ul>
                                    <li><a title='Dados pessoais' class='geral-text white-color'
                                            href='{{ $urlDashboard }}/editar-gestor/{{ $admin_shared['id'] }}'>
                                            <span class="iconify"
                                    ...
                                    <li><a title='Logout' class='geral-text white-color user-logout'
                                            onclick='openModal("logout-modal")' href="#"><span class="iconify"
                                                data-icon="feather:log-out"></span> Logout</a></li>
                                </ul>
                            </div>
    ...
    <!-- Simditor  -->
    <script src="/lib/simditor-2.3.28/site/assets/scripts/module.js"></script>
    <script src="/lib/simditor-2.3.28/site/assets/scripts/hotkeys.js"></script>
    <script src="/lib/simditor-2.3.28/site/assets/scripts/uploader.js"></script>
