...
/***/ "./resources/assets/js/site/bootstrap.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/site/bootstrap.js ***!
  \***********************************************/
...
/***/ "./resources/assets/js/site/contato.js":
/*!*********************************************!*\
  !*** ./resources/assets/js/site/contato.js ***!
  \*********************************************/
/***/ (() => {
...
/***/ "./resources/assets/js/site/lazy-load.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/site/lazy-load.js ***!
  \***********************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if ("IntersectionObserver" in window) {
    ...
    var _lazyloadBackgrounds2 = function _lazyloadBackgrounds() {
      ...
      lazyloadThrottleTimeoutBackgrounds = setTimeout(function () {
        ...
        _lazyloadBackgrounds2.forEach(function (img) {
          if (img.offsetTop < window.innerHeight + scrollTop) {
            img.src = img.dataset.src;
        ...
        if (_lazyloadBackgrounds2.length == 0) {
          document.removeEventListener("scroll", lazyload, _lazyloadBackgrounds2);
          window.removeEventListener("resize", lazyload, _lazyloadBackgrounds2);
          window.removeEventListener("orientationChange", lazyload, _lazyloadBackgrounds2);
        }
      }, 20);
    };
    ...
    _lazyloadBackgrounds2 = document.querySelectorAll(".background-lazy");
    document.addEventListener("scroll", function () {
      lazyload, _lazyloadBackgrounds2;
    });
...
$(".custom-modal .background, .custom-modal .close-modal").on("click", function () {
  var id = $(this).parents(".custom-modal").attr("id");
  closeModal(id);
});
...
window.setLeftPosition = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
  var defaultMarginLeft;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          defaultMarginLeft = $('.container').css('margin-left');
...
window.loadBannerSwiper = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
...
/***/ "./resources/assets/js/site/site-validator.js":
/*!****************************************************!*\
  !*** ./resources/assets/js/site/site-validator.js ***!
  \****************************************************/
/***/ (() => {
...
/*!*****************************************!*\
  ...
  \*****************************************/
__webpack_require__(/*! ./bootstrap */ "./resources/assets/js/site/bootstrap.js");

var pathArray = window.location.pathname.split('/');
var currentLocation = pathArray[1];

__webpack_require__(/*! ./contato */ "./resources/assets/js/site/contato.js");

__webpack_require__(/*! ./lazy-load */ "./resources/assets/js/site/lazy-load.js");

__webpack_require__(/*! ./main */ "./resources/assets/js/site/main.js");

__webpack_require__(/*! ./mascaras */ "./resources/assets/js/site/mascaras.js");

__webpack_require__(/*! ./site-validator */ "./resources/assets/js/site/site-validator.js");
})();
